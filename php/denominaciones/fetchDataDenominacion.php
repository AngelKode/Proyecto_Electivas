<?php
    ...
    if(isset($_GET['ID'])){
        //Hacemos la peticion para obtener la denominacion
        //Hacemos la peticion a la BD
        $mysql_request = "SELECT * FROM `denominacion` WHERE ID = '".intval($_GET['ID'])."';";
        ...
        //Hacemos la peticion a la BD de todos los datos
